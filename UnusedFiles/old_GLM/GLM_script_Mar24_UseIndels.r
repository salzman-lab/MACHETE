...
# REVERT?#my_quantiles =my_reads[,round(10*quantile(p_predicted,probs=c(0:10)/10)[qi])/10,by=junction]
my_quantiles =my_reads[,round(10*quantile(p_predicted/(1+is.anomaly* p_predicted),probs=c(0:10)/10)[qi])/10,by=junction]
