...
ml load python/2.7.5
python filter_large_fasta.py -d ${OUTPUT_DIR} -s ${STEM}
...
j7_id=`sbatch -J BadFJ_Split ${RESOURCE_FLAG} --mem=5000 --nodes=1 --time=20:0 -o ${1}err_and_out/out_6BadJunc_split.txt -e ${1}err_and_out/err_6BadJunc_split.txt ${INSTALLDIR}LenientBadFJ_SLURM.sh ${FarJuncFasta} ${BadFJver2Dir} ${1} ${INSTALLDIR} | awk '{print $4}'`
...
BadFJj1_id=`sbatch -J ${STEM}FJ_to_genome --mem=50000 --nodes=1 ${RESOURCE_FLAG} --time=36:0:0 -o ${BadFJDir}out_gen.txt -e ${BadFJDir}err_gen.txt ${INSTALLDIR}BowtieAligner.batch.sh "${BOWTIEPARAM}" ${genomeIndex} ${FarJuncFasta} ${BadFJDir}${STEM}_BadFJtoGenome.sam | awk '{print $4}'`
...
BadFJj2_id=`sbatch -J ${STEM}FJ_to_transcriptome --mem=50000 --nodes=1  ${RESOURCE_FLAG} --time=36:0:0 -o ${BadFJDir}out_tran.txt -e ${BadFJDir}err_tran.txt ${INSTALLDIR}BowtieAligner.batch.sh "${BOWTIEPARAM}" ${transcriptomeIndex} ${FarJuncFasta} ${BadFJDir}${STEM}_BadFJtotranscriptome.sam | awk '{print $4}'`
...
BadFJj3_id=`sbatch -J ${STEM}FJ_to_reg --mem=50000 --nodes=1  ${RESOURCE_FLAG} --time=36:0:0 -o ${BadFJDir}out_reg.txt -e ${BadFJDir}err_reg.txt ${INSTALLDIR}BowtieAligner.batch.sh "${BOWTIEPARAM}" ${regIndex} ${FarJuncFasta} ${BadFJDir}${STEM}_BadFJtoReg.sam | awk '{print $4}'`
...
BadFJj4_id=`sbatch -J ${STEM}FJ_to_junc --mem=50000 --nodes=1 ${RESOURCE_FLAG} --time=36:0:0 -o ${BadFJDir}out_junc.txt -e ${BadFJDir}err_junc.txt ${INSTALLDIR}BowtieAligner.batch.sh "${BOWTIEPARAM}" ${juncIndex} ${FarJuncFasta} ${BadFJDir}${STEM}_BadFJtoJunc.sam | awk '{print $4}'`
...
BadFJv2j1_id=`sbatch -J ${STEM}FJ_to_genome --mem=50000 --nodes=1 ${RESOURCE_FLAG} --time=12:0:0 -o ${BadFJver2Dir}out.txt -e ${BadFJver2Dir}err.txt --depend=afterok:${j7_id} ${INSTALLDIR}BowtieAligner_BadFJv2.sh "${genomeBOWTIEPARAM}" | awk '{print $4}'`
...
BadFJv2j2_id=`sbatch -J ${STEM}FJ_to_genome --mem=50000 ${RESOURCE_FLAG} --nodes=1 --time=36:0:0 -o ${BadFJver2Dir}out.txt -e ${BadFJver2Dir}err.txt --depend=afterok:${j7_id} ${INSTALLDIR}BowtieAligner_BadFJv2.sh "${transcriptomeBOWTIEPARAM}" | awk '{print $4}'`
...
BadFJv2j3_id=`sbatch -J ${STEM}FJ_to_genome --mem=50000 ${RESOURCE_FLAG} --nodes=1 --time=36:0:0 -o ${BadFJver2Dir}out.txt -e ${BadFJver2Dir}err.txt --depend=afterok:${j7_id} ${INSTALLDIR}BowtieAligner_BadFJv2.sh "${regBOWTIEPARAM}" | awk '{print $4}'`
...
BadFJv2j4_id=`sbatch -J ${STEM}FJ_to_genome --mem=50000 ${RESOURCE_FLAG} --nodes=1 --time=36:0:0 -o ${BadFJver2Dir}out.txt -e ${BadFJver2Dir}err.txt --depend=afterok:${j7_id} ${INSTALLDIR}BowtieAligner_BadFJv2.sh "${juncBOWTIEPARAM}" | awk '{print $4}'`
