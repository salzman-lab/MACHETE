...
j2_id=`sbatch -J AppendNaiveRpt_ewing ${RESOURCE_FLAG} --array=1-${NUM_FILES_Ewing} --mem=55000 --nodes=4 --time=2:0:0 -o ${Output_Ewing}err/out_AppendNaive.txt -e ${Output_Ewing}err/err_AppendNaive.txt ${INSTALLDIR}AppendNaiveRept.sh ${FJDir_Ewing} ${CircPipe_Ewing}circReads/glmReports/ ${INSTALLDIR} ${Output_Ewing}glmReports/ ${Output_Ewing}AppendedReports/ | awk '{print $4}'`
...
j2_id=`sbatch -J AppendNaiveRpt_bladder ${RESOURCE_FLAG} --array=1-${NUM_FILES_bladder} --mem=55000 --nodes=4 --time=2:0:0 -o ${Output_bladder}err/out_AppendNaive.txt -e ${Output_bladder}err/err_AppendNaive.txt ${INSTALLDIR}AppendNaiveRept.sh ${FJDir_bladder} ${CircPipe_bladder}circReads/glmReports/ ${INSTALLDIR} ${Output_bladder}glmReports/ ${Output_bladder}AppendedReports/ | awk '{print $4}'`
...
j2_id=`sbatch -J AppendNaiveRpt_CML_test ${RESOURCE_FLAG} --array=1-${NUM_FILES_CML_test} --mem=55000 --nodes=4 --time=2:0:0 -o ${Output_CML_test}err/out_AppendNaive.txt -e ${Output_CML_test}err/err_AppendNaive.txt ${INSTALLDIR}AppendNaiveRept.sh ${FJDir_CML_test} ${CircPipe_CML_test}circReads/glmReports/ ${INSTALLDIR} ${Output_CML_test}glmReports/ ${Output_CML_test}AppendedReports/ | awk '{print $4}'`
...
j2_id=`sbatch -J AppendNaiveRpt_prostate ${RESOURCE_FLAG} --array=1-${NUM_FILES_prostate} --mem=55000 --nodes=4 --time=2:0:0 -o ${Output_prostate}err/out_AppendNaive.txt -e ${Output_prostate}err/err_AppendNaive.txt ${INSTALLDIR}AppendNaiveRept.sh ${FJDir_prostate} ${CircPipe_prostate}circReads/glmReports/ ${INSTALLDIR} ${Output_prostate}glmReports/ ${Output_prostate}AppendedReports/ | awk '{print $4}'`
...
j2_id=`sbatch -J AppendNaiveRpt_normal_fetal ${RESOURCE_FLAG} --array=1-${NUM_FILES_normal_fetal} --mem=55000 --nodes=4 --time=2:0:0 -o ${Output_normal_fetal}err/out_AppendNaive.txt -e ${Output_normal_fetal}err/err_AppendNaive.txt ${INSTALLDIR}AppendNaiveRept.sh ${FJDir_normal_fetal} ${CircPipe_normal_fetal}circReads/glmReports/ ${INSTALLDIR} ${Output_normal_fetal}glmReports/ ${Output_normal_fetal}AppendedReports/ | awk '{print $4}'`
...
j2_id=`sbatch -J AppendNaiveRpt_Engstrom ${RESOURCE_FLAG} --array=1-${NUM_FILES_Engstrom} --mem=55000 --nodes=4 --time=2:0:0 -o ${Output_Engstrom}err/out_AppendNaive.txt -e ${Output_Engstrom}err/err_AppendNaive.txt ${INSTALLDIR}AppendNaiveRept.sh ${FJDir_Engstrom} ${CircPipe_Engstrom}circReads/glmReports/ ${INSTALLDIR} ${Output_Engstrom}glmReports/ ${Output_Engstrom}AppendedReports/ | awk '{print $4}'`
...
j2_id=`sbatch -J AppendNaiveRpt_SEQC ${RESOURCE_FLAG} --array=1-${NUM_FILES_SEQC} --mem=55000 --nodes=4 --time=2:0:0 -o ${Output_SEQC}err/out_AppendNaive.txt -e ${Output_SEQC}err/err_AppendNaive.txt ${INSTALLDIR}AppendNaiveRept.sh ${FJDir_SEQC} ${CircPipe_SEQC}circReads/glmReports/ ${INSTALLDIR} ${Output_SEQC}glmReports/ ${Output_SEQC}AppendedReports/ | awk '{print $4}'`
...
j2_id=`sbatch -J AppendNaiveRpt_ov_RNase_Qatar ${RESOURCE_FLAG} --array=1-${NUM_FILES_ov_RNase_Qatar} --mem=55000 --nodes=4 --time=2:0:0 -o ${Output_ov_RNase_Qatar}err/out_AppendNaive.txt -e ${Output_ov_RNase_Qatar}err/err_AppendNaive.txt ${INSTALLDIR}AppendNaiveRept.sh ${FJDir_ov_RNase_Qatar} ${CircPipe_ov_RNase_Qatar}circReads/glmReports/ ${INSTALLDIR} ${Output_ov_RNase_Qatar}glmReports/ ${Output_ov_RNase_Qatar}AppendedReports/ | awk '{print $4}'`
